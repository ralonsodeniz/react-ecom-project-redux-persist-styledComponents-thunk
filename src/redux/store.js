...
const middlewares = [thunk]; // we create an array with all the middlewares we want to use so then we can spread this array as the parameter of applyMiddleware method so each of them is passed as a parameter.
